...
class PelangganController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->redirect == 'transaksi') {
            return redirect('/kasir/transaksi/create?pelanggan_id='.$pelanggan->pelanggan_id)
                ->with('success','Pelanggan berhasil ditambahkan');
        }

        return redirect('/kasir/pelanggan')->with('success','Data berhasil ditambah');
    }
    /**
    ...
    public function update(Request $request, Pelanggan $pelanggan)
    {
        ...
        return redirect('/kasir/pelanggan')->with('success','Data berhasil diupdate');
}
